...
const Nabvar = () => {
    ...
    const items = <>
        ...
        {
            user && <>
                <li><Link to='dashbord/enrolled-class'>Dashboard</Link></li>
    ...
    return (
        <div className="navbar bg-base-300 font-normal shadow-lg " style={{ position: 'fixed', top: 0, left: 0, right: 0, zIndex: 100 ,}}>
            <div className="navbar-start">
                ...
                <a className=" normal-case text-2xl font-semibold">BSPI <span className='text-yellow-400'>Programming Club</span> </a>
            </div>
